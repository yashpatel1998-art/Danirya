...
import { revealStyle, useContactReveal } from '@/hooks/useContactReveal';
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.editorial}>
          <h2
            ...
            style={revealStyle(stages.heading)}
          >
            Let&apos;s Build Something Extraordinary
          </h2>
          <p
            className={styles.subtitle}
            style={revealStyle(stages.subtitle)}
          >
        ...
        <ContactForm
          formReveal={stages.form}
          ctaReveal={stages.cta}
        />
      </div>
    </section>
  );
